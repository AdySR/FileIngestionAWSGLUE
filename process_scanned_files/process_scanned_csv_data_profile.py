...
def process_scanned_csv_data_profile(source_file_full_path_dict):
    ...
    # dict= {'CustomerData_20220330.csv': 'C:\\programs\\pyprojects\\FileIngestionAWS\\file_ingestion_file_source\\CustomerData_20220330.csv', 'organizations_100.csv': 'C:\\programs\\pyprojects\\FileIngestionAWS\\file_ingestion_file_source\\organizations_100.csv', 'people_100.csv': 'C:\\programs\\pyprojects\\FileIngestionAWS\\file_ingestion_file_source\\people_100.csv'}
